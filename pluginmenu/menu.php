 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_ft')){
	function azrcrv_create_plugin_menu_ft(){
		azrcrv_populate_plugin_menu_ft();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_ft')){
	function azrcrv_populate_plugin_menu_ft(){
